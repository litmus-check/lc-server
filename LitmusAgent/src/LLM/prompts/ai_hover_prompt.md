...
Example:
{"action": "ai_hover","prompt": "Hover over the Submit button"}
...
{"Actions":[{"type":"ai_hover","elementId":1}],"Reasoning":"Explanation of why the prompt refers to this element id","Warning":"Warning if the LLM is deviating from the task"}

Action Examples:
{"Actions":[{"type":"ai_hover","elementId":1}],"Reasoning":"Hovering over the submit button to show tooltip","Warning":""}
