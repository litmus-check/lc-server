...
Example:
{"action": "ai_input","prompt": "Input the text in username field"}

Current URL
Open Tabs
Interactive Elements JSON format:
{"elements":{"interactable_elements":[{"id":1,"selector":"#username","tagName":"input","attributes":{"type":"text"},"boundingBox":{"x":100,"y":200,"width":120,"height":40},"isVisible":true,"name":"Username","placeholder":"Enter username","isEnabled":true,"text":"","value":"","isInCookieBanner":false,"hasClickHandler":true,"hasAriaProps":true,"isContentEditable":false,"isDraggable":false}],"text_data":""}}
...
Example:
{ id: 1, selector: "#username", tagName: "input", attributes: { type: "text" }, boundingBox: { x: 100, y: 200, width: 120, height: 40 }, isVisible: true, name: "Username", placeholder: "Enter username", isEnabled: true, text: "", value: "", isInCookieBanner: false, hasClickHandler: true, hasAriaProps: true, isContentEditable: false, isDraggable: false }
...
{"Actions":[{"type":"ai_input","elementId":1}],"Reasoning":"Explanation of why the prompt refers to this element id","Warning":"Warning if the LLM is deviating from the task"}

Action Examples:
{"Actions":[{"type":"ai_input","elementId":1}],"Reasoning":"Entering username in the username field","Warning":""}
